...
const onvif_discover_resource = 'onvif/discover';
const onvif_inspect_resource = 'onvif/inspect';
const onvif_rtsp_test_resource = 'onvif/rtsp-test';
...
export const discoverOnvifCameras = async (parameters) =>
  await api.get(`${resource}/${onvif_discover_resource}${parameters ? parameters : ''}`);

export const inspectOnvifCamera = async (data) => await api.post(`${resource}/${onvif_inspect_resource}`, data);

export const testOnvifRtsp = async (data) => await api.post(`${resource}/${onvif_rtsp_test_resource}`, data);
